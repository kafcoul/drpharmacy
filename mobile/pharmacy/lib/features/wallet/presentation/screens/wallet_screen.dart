...
class _WalletScreenState extends ConsumerState<WalletScreen>
  ...
  void _showAutoReportSettingsSheet(BuildContext context) async {
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (context, setModalState) {
          ...
          if (isLoading && currentPref == null) {
            StatementPreferenceService.getPreferences().then((pref) {
              setModalState(() {
                currentPref = pref;
                isLoading = false;
              });
            ...
            child: isLoading 
                ...
                : _AutoReportSettingsContent(
                    ...
                    onSave: (freq, fmt, auto) async {
                      ...
                      final result = await StatementPreferenceService.savePreferences(
